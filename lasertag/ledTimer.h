...
// Controls both hitLed and JF-10. Make sure to disable the hitLedTimer when using this timer.
...
// E.G., if ticksPerMillisecond is 10, the tick function will be called 10 times each millisecond.
