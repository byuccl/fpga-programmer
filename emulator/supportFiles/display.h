...
// Available QT colors. Constant values are from Qt documentation though #define constants could have been anything.
...
// Allow students to use main(). user_main is the emulator's entry point into student's main.
...
//   void display_drawLoadedXPixMap(int16_t x, int16_t y, int16_t w, int16_t h, xpm_data_t *xpm_data);
//   void display_drawLoadedCircledXPixMap(int16_t x, int16_t y, int16_t radius, xpm_data_t *xpm_data);
//   // Slower functions, that re-parse the XPM every time
//   void display_drawXPixMap(int16_t x, int16_t y, int16_t w, int16_t h, char **xpm);
//   void display_drawCircledXPixMap(int16_t x, int16_t y, int16_t radius, char **xpm);
